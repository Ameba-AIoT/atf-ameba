...
#ifdef __aarch64__
#define AMEBA_CONFIGURE_BL2_MMU(...)	ameba_configure_mmu_el1(__VA_ARGS__)
#else
#define AMEBA_CONFIGURE_BL2_MMU(...)	ameba_configure_mmu_svc_mon(__VA_ARGS__)
#endif

void bl2_plat_arch_setup(void)
{
	AMEBA_CONFIGURE_BL2_MMU(bl2_tzram_layout.total_base,
 ...
 ******************************************************************************/
static uint32_t ameba_get_spsr_for_bl32_entry(void)
{
#ifdef __aarch64__
	/*
 ...
 ******************************************************************************/
static uint32_t ameba_get_spsr_for_bl33_entry(void)
{
	uint32_t spsr;
#ifdef __aarch64__
	unsigned int mode;
...
static int ameba_bl2_handle_post_image_load(unsigned int image_id)
{
	int err = 0;
	...
	case BL32_IMAGE_ID:
		 ...
		 */
		bl_mem_params->ep_info.args.arg3 = PLAT_AMEBASMART_DT_BASE;
#else /* case AARCH32_SP_OPTEE */
		bl_mem_params->ep_info.args.arg0 =
					bl_mem_params->ep_info.args.arg1;
		bl_mem_params->ep_info.args.arg1 = 0;
		bl_mem_params->ep_info.args.arg2 = PLAT_AMEBASMART_DT_BASE;
		bl_mem_params->ep_info.args.arg3 = 0;
#endif
#endif
		bl_mem_params->ep_info.spsr = ameba_get_spsr_for_bl32_entry();
		break;
	...
	case BL33_IMAGE_ID:
		...
		MPC1->ENTRY[7].IDAU_BARx = AMEBA_OPTEE_SHMEM_START - DRAM_START_ADDR;
#else
		...
		bl_mem_params->ep_info.spsr = ameba_get_spsr_for_bl33_entry();
...
{
	return ameba_bl2_handle_post_image_load(image_id);
}
