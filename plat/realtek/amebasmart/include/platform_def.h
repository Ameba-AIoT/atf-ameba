...
#define AMEBA_BL31_PLAT_PARAM_VAL	0x0f1e2d3c4b5a6978ULL
...
#define PLAT_AMEBASMART_TRUSTED_MAILBOX_BASE	SHARED_RAM_BASE
#define PLAT_AMEBASMART_TRUSTED_MAILBOX_SIZE	(8 + PLAT_AMEBASMART_HOLD_SIZE)
#define PLAT_AMEBASMART_HOLD_BASE		(PLAT_AMEBASMART_TRUSTED_MAILBOX_BASE + 8)
#define PLAT_AMEBASMART_HOLD_SIZE		(PLATFORM_CORE_COUNT * \
					 PLAT_AMEBASMART_HOLD_ENTRY_SIZE)
#define PLAT_AMEBASMART_HOLD_ENTRY_SIZE	8
#define PLAT_AMEBASMART_HOLD_STATE_WAIT	0
#define PLAT_AMEBASMART_HOLD_STATE_GO		1

#define PLAT_AMEBASMART_WARM_BOOT_BASE		(PLAT_AMEBASMART_TRUSTED_MAILBOX_BASE + 0x100)
#define PLAT_AMEBASMART_WARM_BOOT_SIZE		4
...
#define AMEBA_OPTEE_PAGEABLE_LOAD_BASE	(BL32_BASE + 0x00200000)
#define AMEBA_OPTEE_PAGEABLE_LOAD_SIZE	0x00100000

#define AMEBA_OPTEE_SHMEM_START		0x602e0000
#define AMEBA_OPTEE_SHMEM_SIZE		0x00020000
...
#define PLAT_AMEBASMART_BOOT_UART_BASE	UART0_BASE
#define PLAT_AMEBASMART_BOOT_UART_CLK_IN_HZ	UART0_CLK_IN_HZ   	// not used

#define PLAT_AMEBASMART_CRASH_UART_BASE		UART1_BASE
#define PLAT_AMEBASMART_CRASH_UART_CLK_IN_HZ	UART1_CLK_IN_HZ

#define PLAT_AMEBASMART_CONSOLE_BAUDRATE	1500000

#define AMEBA_FLASH0_BASE		0x60400000
#define AMEBA_FLASH0_SIZE		0x00C00000

#define PLAT_AMEBASMART_FIP_BASE		AMEBA_FLASH0_BASE
#define PLAT_AMEBASMART_FIP_MAX_SIZE	AMEBA_FLASH0_SIZE
 ...
 */
#if (BOOT_FLASH)
#define PLAT_AMEBASMART_DT_BASE		(SEC_ROM_BASE + 0x40000)
#define PLAT_AMEBASMART_DT_MAX_SIZE		0x000c0000
#else
#define PLAT_AMEBASMART_DT_BASE		0x81f00000
#define PLAT_AMEBASMART_DT_MAX_SIZE		0x000c0000
#endif
