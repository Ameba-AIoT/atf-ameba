...
AMEBA_CPU_LIBS		:=	lib/cpus/$(ARCH)/aem_generic.S
ifeq (${HW_ASSISTED_COHERENCY}, 0)
AMEBA_CPU_LIBS		+=	lib/cpus/$(ARCH)/cortex_a7.S		\
...
AMEBA_CPU_LIBS		+=	lib/cpus/$(ARCH)/cortex_a55.S		\
				lib/cpus/$(ARCH)/cortex_a75.S
endif

PLAT_INCLUDES		:=	-Iinclude/plat/arm/common/		\
				-Iinclude/plat/arm/common/aarch64/	\
				-Iplat/realtek/amebasmart/include		\
				-Iinclude/common/tbbr

include lib/xlat_tables_v2/xlat_tables.mk
PLAT_BL_COMMON_SOURCES	:=	plat/realtek/amebasmart/ameba_common.c	\
				plat/realtek/amebasmart/ameba_console_setup.c \
				plat/realtek/amebasmart/$(ARCH)/plat_helpers.S \
				drivers/ameba/uart/$(ARCH)/ameba_console.S \
...
BL1_SOURCES		+=	drivers/io/io_semihosting.c		\
				...
				plat/realtek/amebasmart/ameba_io_storage.c	\
				${AMEBA_CPU_LIBS}			\
				plat/realtek/amebasmart/ameba_bl1_setup.c
ifeq (${BOOT_FLASH}, 1)
BL1_SOURCES		+=	plat/realtek/amebasmart/spi/spi-ameba.c	\
			  	plat/realtek/amebasmart/ddr_init/ddr_init_ameba.c
endif
...
BL2_SOURCES		+=	drivers/io/io_semihosting.c		\
				...
				lib/semihosting/$(ARCH)/semihosting_call.S		\
				plat/realtek/amebasmart/ameba_io_storage.c			\
				plat/realtek/amebasmart/ameba_bl2_setup.c			\
				plat/realtek/amebasmart/ameba_bl2_mem_params_desc.c	\
				plat/realtek/amebasmart/ameba_image_load.c			\
...
ifeq (${ARM_GIC_ARCH},2)
AMEBA_GIC_SOURCES	=	drivers/arm/gic/common/gic_common.c	\
...
AMEBA_GIC_SOURCES	=	${GICV3_SOURCES}
endif

AMEBA_GIC_SOURCES	+=	plat/common/plat_gicv${ARM_GIC_ARCH}.c	\
				plat/realtek/amebasmart/ameba_gic.c

BL31_SOURCES		+=	${AMEBA_CPU_LIBS}			\
				plat/common/plat_psci_common.c		\
				plat/realtek/amebasmart/ameba_pm.c		\
				plat/realtek/amebasmart/topology.c		\
				plat/realtek/amebasmart/ameba_bl31_setup.c	\
				${AMEBA_GIC_SOURCES}
...
BL1_SOURCES		+=	${AUTH_SOURCES}			\
			...
			plat/realtek/amebasmart/ameba_bl1_fwu.c	\
			plat/realtek/amebasmart/board_ameba_trusted_boot.c
