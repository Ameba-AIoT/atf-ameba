...
#if RESET_TO_SP_MIN
#error ameba does not support RESET_TO_SP_MIN
#endif
		...
		u_register_t arg2, u_register_t arg3)
{
	...
	VERBOSE("[sp_min] ameba console init\n");
	/*
...
{
	ameba_configure_mmu_svc_mon(BL32_BASE, BL32_END - BL32_BASE,
...
void sp_min_platform_setup(void)
{
	...
	plat_amebasmart_gic_driver_init();
	plat_amebasmart_gic_init();
